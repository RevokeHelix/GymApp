    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', marginBottom: 36 }}>
        ...
        <div style={{
          ...
          letterSpacing: '0.2em', color: 'var(--accent)', marginTop: 4,
        }}>TRACK EVERY REP</div>
      </div>
          ...
          {mode === 'signup' && (
            <Field label="CONFIRM PASSWORD">
              <input
                ...
                minLength={6}
                style={inp({
                  borderColor: confirm && confirm !== password ? 'var(--red)' : 'var(--border-2)',
                })}
                placeholder="••••••••"
                value={confirm}
                ...
                onBlur={e => {
                  e.target.style.borderColor =
                    confirm && confirm !== password ? 'var(--red)' : 'var(--border-2)'
                }}
      ...
      <div style={{
        marginTop: 24, fontFamily: 'var(--mono)', fontSize: 11,
        color: 'var(--text-dim)', textAlign: 'center', letterSpacing: '0.04em',
      }}>
